...
namespace PROCTOR.Infrastructure.Migrations
{
    ...
    [Migration("20260619095109_AddCaseHearingPersons")]
    partial class AddCaseHearingPersons
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PROCTOR.Domain.Entities.Article", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("PROCTOR.Domain.Entities.Case", b =>
                {
                    ...
                    b.Property<string>("AcknowledgmentComment")
                        .HasColumnType("text");
                    ...
                    b.Property<string>("HearingPersons")
                        .IsRequired()
                        .HasColumnType("jsonb");
                    ...
                    b.Property<string>("IncidentLocationDescription")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("PROCTOR.Domain.Entities.CaseAccused", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");

                    b.Property<string>("AccusedStudentId")
                        .IsRequired()
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("PROCTOR.Domain.Entities.CaseAssignment", b =>
                {
                    ...
                    b.HasIndex("CaseId", "UserId", "IsActive");

                    b.ToTable("CaseAssignments");
                });

            modelBuilder.Entity("PROCTOR.Domain.Entities.CaseCategory", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("PROCTOR.Domain.Entities.CaseComplainant", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("CaseComplainants");
                });

            modelBuilder.Entity("PROCTOR.Domain.Entities.CaseSubject", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("PROCTOR.Domain.Entities.ForwardingRule", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("PROCTOR.Domain.Entities.Rank", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("PROCTOR.Domain.Entities.SentEmail", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("PROCTOR.Domain.Entities.Case", b =>
                {
                    ...
                    b.HasOne("PROCTOR.Domain.Entities.CaseCategory", "Category")
                        .WithMany()
